# README: plot2.py - Omega Meson Mass at $eB = 12 m_\pi^2$

This document describes the structure, equations, parameters, and step-by-step logic of [plot2.py](file:///home/reethep/msc_2027/plot2.py), which recreates Figure 2 of the paper (the $\omega$ meson mass vs density for $eB = 12 m_\pi^2$).
...
2.  **Evaluating the Medium:**
    ...
    *   Evaluates the rational scale factor for the nonstrange field $\sigma$:
        ...
        *   **$\eta=0$ (with AMM):** $a=0.486726, b=-0.077313, c=-0.055689$
        *   **$\eta=0.3$ (with AMM):** $a=0.472382, b=-0.079572, c=-0.038349$
        *   **$\eta=0.5$ (with AMM):** $a=0.648666, b=0.330907, c=1.539334$
        *   **$\eta=0$ (without AMM):** $a=0.486865, b=-0.065412, c=-0.044204$
        *   **$\eta=0.3$ (without AMM):** $a=0.470884, b=-0.071941, c=-0.051695$
...
4.  **Plotting:**
    ...
    *   Saves the figure as `plots/plot2.png`.
