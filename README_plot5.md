# README: plot5.py - Phi Meson Mass at $eB = 4 m_\pi^2$

This document describes the structure, equations, parameters, and step-by-step logic of [plot5.py](file:///home/reethep/msc_2027/plot5.py), which recreates Figure 5 of the paper (the $\phi$ meson mass vs density for $eB = 4 m_\pi^2$).
...
2.  **Evaluating the Medium:**
    ...
    *   Evaluates the rational scale factor for the strange field $\zeta$:
        ...
        *   **$\eta=0$ (with AMM):** $a=0.146417, b=-0.010888, c=1.039004$
        *   **$\eta=0.3$ (with AMM):** $a=0.142887, b=-0.010153, c=1.023329$
        *   **$\eta=0.5$ (with AMM):** $a=0.140873, b=-0.008611, c=1.050012$
        *   **$\eta=0$ (without AMM):** $a=0.147779, b=-0.011944, c=1.027035$
        *   **$\eta=0.3$ (without AMM):** $a=0.144363, b=-0.011119, c=1.011066$
...
4.  **Plotting:**
    ...
    *   Saves the figure as `plots/plot5.png`.
