# Self-contained code for Plot 1
...
m_vac = 0.783
d_V = 0.16666666666666666
kappa = 7.695407818443155
...
fits_data = [{'eta': 0.0, 'amm': True, 'a': 0.4865722356804103, 'b': -0.0779402463512277, 'c': -0.0575084599430202, 'xmin': 9.374999999992029e-06, 'xmax': 2.4169687499999997}, {'eta': 0.3, 'amm': True, 'a': 0.4700628924333372, 'b': -0.06428769484284394, 'c': -0.01726765036253571, 'xmin': 9.374999999992029e-06, 'xmax': 2.4034218750000003}, {'eta': 0.5, 'amm': True, 'a': 0.6714480940504173, 'b': 0.5443985037535415, 'c': 2.097650522150671, 'xmin': 9.374999999992029e-06, 'xmax': 2.3822968749999998}, {'eta': 0.0, 'amm': False, 'a': 0.4879453775902758, 'b': -0.07468168895060068, 'c': -0.05866575807284091, 'xmin': 9.374999999992029e-06, 'xmax': 2.4246250000000003}, {'eta': 0.3, 'amm': False, 'a': 0.4701887443182708, 'b': -0.07159291685946174, 'c': -0.05174903388760813, 'xmin': 9.374999999992029e-06, 'xmax': 2.40965625}, {'eta': 0.5, 'amm': False, 'a': 0.4686725447480605, 'b': -0.07634956459423944, 'c': -0.0400973677273653, 'xmin': 9.374999999992029e-06, 'xmax': 2.3895468749999997}]
...
def main():
    ...
    for fit in fits_data:
        ...
        for x in x_phys:
            ...
            pi_0 = rho_B_phys / (4.0 * 0.938) if "omega" != "phi" else 0.0
    ...
    plt.title(f'$eB = 4 m_\pi^2$', fontsize=12, pad=10)
    plt.grid(True, linestyle=':', alpha=0.6)
    plt.legend(loc='lower left' if "omega" == "omega" else 'upper right', frameon=True, edgecolor='black', fontsize=10)
    plt.tight_layout()
