# README: plot3.py - Rho Meson Mass at $eB = 4 m_\pi^2$

This document describes the structure, equations, parameters, and step-by-step logic of [plot3.py](file:///home/reethep/msc_2027/plot3.py), which recreates Figure 3 of the paper (the $\rho$ meson mass vs density for $eB = 4 m_\pi^2$).
...
2.  **Evaluating the Medium:**
    ...
    *   Evaluates the rational scale factor for the nonstrange field $\sigma$:
        ...
        *   **$\eta=0$ (with AMM):** $a=0.564316, b=-0.160408, c=0.016504$
        *   **$\eta=0.3$ (with AMM):** $a=0.527717, b=-0.144367, c=0.014827$
        *   **$\eta=0.5$ (with AMM):** $a=0.510068, b=-0.144976, c=0.015926$
        *   **$\eta=0$ (without AMM):** $a=0.575342, b=-0.162707, c=0.016587$
        *   **$\eta=0.3$ (without AMM):** $a=0.544360, b=-0.151405, c=0.015707$
        *   **$\eta=0.5$ (without AMM):** $a=0.532053, b=-0.155090, c=0.017214$
...
4.  **Plotting:**
    ...
    *   Saves the figure as `plots/plot3.png`.
